...
const hosts: Host[] = [
  {
    ...
    capabilities: {
      ...
      interfaces: [
        { name: 'eth0', type: 'physical', addresses: ['203.0.113.10/24'], isUp: true },
        { name: 'eth1', type: 'physical', addresses: ['10.0.1.1/24'], isUp: true },
        { name: 'wg0', type: 'wireguard', addresses: ['10.200.0.1/24'], isUp: true },
      ],
      runningServices: [
...
export const demoSnapshots: Snapshot[] = [
  {
    id: 'demo-snapshot-1',
    hostId: HOST_WEB01,
    iptablesSaveV4: '# Generated by iptables-save v1.8.9\n*filter\n:INPUT DROP\n:FORWARD DROP\n:OUTPUT ACCEPT\n-A INPUT -p tcp --dport 80 -j ACCEPT\n-A INPUT -p tcp --dport 443 -j ACCEPT\n-A INPUT -p tcp --dport 22 -j ACCEPT\nCOMMIT',
    parsedRules: web01Rules,
    timestamp: ts(60),
    description: 'After adding web traffic rules',
  },
  {
    id: 'demo-snapshot-2',
    hostId: HOST_WEB01,
    iptablesSaveV4: '# Generated by iptables-save v1.8.9\n*filter\n:INPUT DROP\n:FORWARD DROP\n:OUTPUT ACCEPT\n-A INPUT -p tcp --dport 80 -j ACCEPT\n-A INPUT -p tcp --dport 443 -j ACCEPT\n-A INPUT -p tcp --dport 22 -s 203.0.113.10/32 -j ACCEPT\n-A INPUT -p tcp --dport 9100 -s 10.0.0.0/8 -j ACCEPT\nCOMMIT',
    parsedRules: web01Rules,
    timestamp: ts(30),
    description: 'Restricted SSH to office IPs',
  },
  {
    id: 'demo-snapshot-3',
    hostId: HOST_WEB01,
    ...
    parsedRules: web01Rules,
    timestamp: ts(5),
    description: 'Added monitoring and default deny',
  },
];
